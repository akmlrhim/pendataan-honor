...
class KontrakController extends Controller
{
  ...
  public function update(Request $request, $id)
  {
     ...
     * =============================
     */
    DB::transaction(function () use ($request, $kontrak, $existingTugasIds, &$requestTugasIds) {
  ...
  public function destroy($id)
  {
    ...
    return $deleted ?
      back()->with('success', 'Kontrak berhasil dihapus.') :
      back()->with('error', 'Terjadi kesalahan saat menghapus kontrak.');
  }
