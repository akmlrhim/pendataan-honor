              ...
              <div class="form-group">
                ...
                <input type="text"
                  class="form-control form-control-sm @error('nms')
									is-invalid
								@enderror" id="nms"
                  name="nms" placeholder="Masukkan NMS" value="{{ old('nms', $mitra->nms) }}" autocomplete="off">
                @error('nms')
              ...
              <div class="form-group">
                ...
                <div>
                  <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label text-sm" for="jenis_kelamin_l">Laki-laki</label>
                  </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <textarea class="form-control form-control-sm @error('alamat')
									is-invalid
								@enderror" id="alamat"
                  rows="8" placeholder="Masukkan alamat" name="alamat">{{ old('alamat', $mitra->alamat) }}</textarea>
                @error('alamat')
                  <x-input-validation>{{ $message }}</x-input-validation>
                @enderror
              </div>
