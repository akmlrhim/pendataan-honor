...
@section('content')
  <div class="col-md-12">
    <div class="card card-primary">
      <div class="card-body">
        <form method="POST" action="{{ route('tambahan.store') }}">
          @csrf
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control @error('key') is-invalid @enderror" id="key"
                    placeholder="Masukkan key" name="key" value="{{ old('key') }}" autocomplete="off" />
                </div>
                @error('key')
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control @error('value') is-invalid @enderror" id="value"
                    placeholder="Masukkan value" name="value" value="{{ old('value') }}" autocomplete="off" />
                </div>
                @error('value')
                  <small class="text-danger text-sm">{{ ucfirst($message) }}</small>
                @enderror
